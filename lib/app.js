...
app.get('/getGameStatus', authorize, gameHandlers.getGameStatus);

app.post('/joinGame', gameHandlers.joinGame);
app.post('/createGame', gameHandlers.createGame);

app.get('/getPath', authorize, staticHandlers.getPath);
...
app.get('/possiblePositions', authorize, movementHandlers.getPossiblePositions);
app.get('/changeTurn', authorize, gameHandlers.changeTurn);
app.get(
